...
class AguaUsoEficienteController extends Controller
{
    ...
    {
        $request->validate([
            // Elimina esta validación ya que obtienes el ID de la ruta
            // 'visita_ambiental_id' => 'required|exists:visita_ambientales,id'
        ]);
        ...
        AguaUsoEficiente::create([
            'visita_ambiental_id' => $visita_id, // Usar el ID de la ruta
