                ...
                <div class="card-header bg-gradient-warning text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 text-black">
                            ...
                            Editar Planificación Agronómica
                        </h4>
                        <div class="badge bg-black text-warning p-2">
                            <i class="fas fa-leaf me-1"></i> ID: {{ $planificacion->id }}
                        </div>
                    </div>
                </div>
                
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('planificaciones.update', $planificacion->id) }}" id="planificacionForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="fecha" class="form-control form-control-lg" required 
                                           value="{{ old('fecha', $planificacion->fecha) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="tipo_visita" class="form-select form-select-lg" required
                                        ...
                                        <option value="Inicial" {{ old('tipo_visita', $planificacion->tipo_visita) == 'Inicial' ? 'selected' : '' }}>
                                            🏁 Inicial
                                        </option>
                                        ...
                                        <option value="Mantenimiento" {{ old('tipo_visita', $planificacion->tipo_visita) == 'Mantenimiento' ? 'selected' : '' }}>
                                            🔧 Mantenimiento
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="estado" class="form-select form-select-lg" required
                                        ...
                                        <option value="pendiente" {{ old('estado', $planificacion->estado) == 'pendiente' ? 'selected' : '' }}>
                                            ⏳ Pendiente
                                        </option>
                                        <option value="realizada" {{ old('estado', $planificacion->estado) == 'realizada' ? 'selected' : '' }}>
                                            ✅ Realizada
                                        </option>
                                        <option value="cancelada" {{ old('estado', $planificacion->estado) == 'cancelada' ? 'selected' : '' }}>
                                            ❌ Cancelada
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="alert alert-warning mt-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 small">
                                                Al actualizar, la visita asociada también se modificará automáticamente.
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('planificacionForm').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            text: "¿Estás seguro de que deseas actualizar esta planificación agronómica?",
            icon: 'question',
