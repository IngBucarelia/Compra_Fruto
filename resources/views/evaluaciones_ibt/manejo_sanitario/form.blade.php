    ...
    <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-9">
                    ...
                    <div class="card shadow mb-4">
                            ...
                            <h4 class="mb-0">🩺 IBT – Manejo Sanitario</h4>
                            ...
                            ? route('ibt.manejo_sanitario.update',$registro->id)
                            : route('ibt.manejo_sanitario.store') }}">
                            ...
                            @php
                            $campos = [
                            'censo_enfermedades_plagas' => 8,
                            'oportunidad_control' => 8,
                            'calidad_follaje' => 1,
                            'area_foliar' => 2,
                            'censo_palmas_anormales' => 1,
                            ];
                            @endphp
                            ...
                            <th>Total</th>
                            <th colspan="2" class="text-center">Máx 20 puntos</th>
                            </tr>
