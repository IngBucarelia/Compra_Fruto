...
<style>
    ...
    <form action="{{ route('emisionesGei.store') }}" method="POST">
        ...
        <div class="card-component">
            ...
            <div class="mb-3">
                <label>¿Cuantifica las emisiones de GEI mediante inventarios y/o calculadoras de huella de carbono?</label>
                <select name="cuantifica_emisiones" class="form-control" required>
            ...
            <div class="mb-3">
                ...
                <select name="implementa_acciones_reduccion" class="form-control" required>
                    <option value="">Seleccione…</option>
                    <option value="1">Sí</option>
                    <option value="0">No</option>
                </select>
