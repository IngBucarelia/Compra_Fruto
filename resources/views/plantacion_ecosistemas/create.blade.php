...
@if($visita->aguaCaptacionLegal || $visita->aguaUsoEficiente || $visita->sueloConservacion || $visita->energiaManejo || $visita->gobernanzaHidrica || $visita->emisionesGei || $visita->residuosManejo || $visita->sustanciasQuimicasBiologicas || $visita->vertimientoManejo || $visita->plantacionHmp || $visita->plantacionAvc)
<div class="accordion mb-4 accordion-ambiental" id="accordionAmbiental">
    ...
    {{-- ACORDEÓN 11: PLANTACIÓN AVC (NUEVO) --}}
...
<div class="alert alert-warning mb-4">
    ...
    <div class="mt-3">
        ...
        <a href="{{ route('plantacion_avc.create', $visita->id) }}" class="btn btn-warning">
