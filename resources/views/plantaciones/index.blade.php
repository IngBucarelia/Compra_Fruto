                ...
                <div class="card-header bg-gradient-info py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 text-black-50 small">Administra las plantaciones de los proveedores</p>
                        </div>
                        <div class="text-end">
            ...
            <div class="card shadow">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="{{ route('plantaciones.create') }}"style="background-color: darkgreen" class="btn btn-info btn-lg text-black">
                                    <i class="fas fa-plus-circle me-2"></i>Nueva Plantación
                                </a>
                            </div>
                        </div>
                        @endif
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped mb-0" id="plantacionesTable">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="fw-semibold">{{ $plantacion->proveedor->proveedor_nombre }}</span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center pe-4">
                                            <div class="d-flex justify-content-center gap-2">
                                                <!-- Ver -->
                                                <a href="{{ route('plantaciones.show', $plantacion->id) }}" 
                                                ...
                                                <a href="{{ route('plantaciones.edit', $plantacion->id) }}" 
                                                   ...
                                                   data-bs-toggle="tooltip" title="Editar plantación">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                
                                                <!-- Eliminar con confirmación -->
                                                <form action="{{ route('plantaciones.destroy', $plantacion->id) }}" method="POST" class="d-inline" id="deleteForm-{{ $plantacion->id }}">
                                                    @csrf 
                                                    @method('DELETE')
                                                    <button type="button" 
                                                            ...
                                                            data-plantacion="{{ $plantacion->id }}"
                                                            data-nombre="{{ $plantacion->nombre }}"
                                                            data-proveedor="{{ $plantacion->proveedor->proveedor_nombre }}"
                                                            data-form-id="deleteForm-{{ $plantacion->id }}">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            <div class="text-muted">
                                                ...
                                                <h5>No hay plantaciones registradas</h5>
                                                <p>Comienza creando una nueva plantación</p>
                                                <a href="{{ route('plantaciones.create') }}" class="btn btn-info">
                                                    <i class="fas fa-plus me-2"></i>Crear Primera Plantación
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-btn').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const plantacionId = this.getAttribute('data-plantacion');
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-start">
                        <p><strong>ID:</strong> ${plantacionId}</p>
    ...
    if (searchInput) {
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            const rows = document.querySelectorAll('#plantacionesTable tbody tr');
