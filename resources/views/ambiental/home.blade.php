...
<div class="container dashboard-container">
    <div class="dashboard-content">
        <div class="dashboard-header">
            Area de visitas - Componente Ambiental  <br> En Sesion : {{ auth()->user()->name }}
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mb-4"> {{-- mb-4 añade margen inferior entre filas --}}
                <a href="{{ route('visitasAmbientales.index') }}" class="dashboard-link">
                    <div class="dashboard-card p-4">
                        <div class="dashboard-title">Listado de Visitas</div><br>
                        <img class="logo" src="{{ asset('images/ambiental_home.png') }}" style="border-radius: 30px" alt="Listado de Visitas"><br>
                        <!-- HTML !-->
