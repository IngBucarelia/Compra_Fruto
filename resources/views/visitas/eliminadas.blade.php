...
<div class="container py-4" style="background-color: #fdf4f4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="text-danger mb-0">
            <i class="fas fa-trash-alt me-2"></i> Visitas Agronómicas Eliminadas
        </h4>
        <a href="{{ route('visitas.index') }}" class="btn btn-success">
            <i class="fas fa-arrow-left"></i> Volver
        </a>
    </div>

    <form id="searchForm" method="GET" action="{{ route('visitas.eliminadas') }}" class="mb-3">
    ...
    @else
        <p class="text-center text-muted mt-4">No hay visitas agronómicas eliminadas registradas.</p>
    @endif
</div>
@endsection
